...
\draw[thick] (0.0,0.0) -- (4.0,5.572456);
\node[align=center] at (2.2112176, 2.6346128) { \rotatebox{54.328594769903084}{\large quinta} };
\draw[thick] (0.0,9.599702) -- (4.0,8.054494);
\node[align=center] at (2.0936909, 9.069631) { \rotatebox{-21.121645418695266}{\large tono} };
\draw[dotted] (0.0,0.0) -- (0.0,9.599702);
\node[align=center] at (-0.32000002, 4.799851) { \rotatebox{90.0}{\large ottava} };
\draw[dotted] (4.0,5.572456) -- (4.0,8.054496);
\node[align=center] at (4.32, 6.813476) { \rotatebox{90.0}{\large terza minore} };
\end{tikzpicture}
\end{document}