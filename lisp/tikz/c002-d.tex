...
\draw[thick] (0.0,5.572456) -- (4.0,4.6356244);
\node[align=center] at (2.0592897, 5.35719) { \rotatebox{-13.181535330357288}{\large semitono maggiore} };
\draw[dotted] (0.0,0.0) -- (0.0,5.572456);
\node[align=center] at (-0.32000002, 2.786228) { \rotatebox{90.0}{\large quinta} };
\draw[dotted] (4.0,1.5452088) -- (4.0,4.6356244);
\node[align=center] at (4.32, 3.0904167) { \rotatebox{90.0}{\large terza maggiore} };
\end{tikzpicture}
\end{document}