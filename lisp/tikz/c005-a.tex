...
\draw[thick] (0.0,6.5092883) -- (4.0,8.054496);
\node[align=center] at (1.9063091, 7.524425) { \rotatebox{21.121645418695266}{\large tono} };
\draw[dotted] (0.0,0.0) -- (0.0,6.5092883);
\node[align=center] at (-0.32000002, 3.2546442) { \rotatebox{90.0}{\large sesta minore} };
\draw[dotted] (4.0,-1.5452089) -- (4.0,8.054494);
\node[align=center] at (4.32, 3.2546425) { \rotatebox{90.0}{\large ottava} };
\end{tikzpicture}
\end{document}